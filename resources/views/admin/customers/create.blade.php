                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.customers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required maxlength="150">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required maxlength="20">
                        ...
                        <div class="mb-4 flex space-x-4">
                            <div class="w-1/2">
                                ...
                                <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        <div class="mb-4 flex space-x-4">
                            <div class="w-1/2">
                                ...
                                <select name="dealer_id" id="dealer_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                    ...
                                    @foreach($dealers as $dealer)
                                        <option value="{{ $dealer->dealer_id }}" {{ old('dealer_id') == $dealer->dealer_id ? 'selected' : '' }}>{{ $dealer->dealer_name }} ({{ $dealer->dealer_code }})</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="w-1/2">
                                ...
                                <select name="usk_month" id="usk_month" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                    ...
                                    @for($i=1; $i<=12; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ old('usk_month') == str_pad($i, 2, '0', STR_PAD_LEFT) ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                    @endfor
                                </select>
